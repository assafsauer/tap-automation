...
wget -N https://raw.githubusercontent.com/assafsauer/tap-automation/master/templates/gke-tap-values.yml
...
wget -N https://raw.githubusercontent.com/assafsauer/tap-automation/master/templates/gke-tap-gui-values.yml
envsubst < gke-tap-gui-values.yml > tap-gui-final-val.yml
...
wget -N https://raw.githubusercontent.com/assafsauer/tap-automation/master/templates/gke-tap-scan-test.yml
envsubst < gke-tap-scan-test.yml > tap-test-scan.yaml
